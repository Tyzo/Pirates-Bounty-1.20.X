...
public enum ModArmorMaterials implements ArmorMaterial {
	LEATHER("leather", 25, Util.make(new EnumMap(ArmorItem.Type.class), map -> {
		map.put(ArmorItem.Type.HELMET, 3);
	}), 24, SoundEvents.ITEM_ARMOR_EQUIP_LEATHER, 1.0f, 0.0f, () -> Ingredient.ofItems(Items.LEATHER));
	...
	public String getName() {
		return PiratesBountyMod.MOD_ID + ":" + this.name;
	}
