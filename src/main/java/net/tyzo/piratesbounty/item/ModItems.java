...
import net.tyzo.piratesbounty.item.custom.MusketItem;
...
//	public static final Item MUSKET = registerItem("musket", new CrossbowItem(new FabricItemSettings().maxDamage(1024)));
	...
	public static final Item FLINTLOCK_MUSKET = registerItem("flintlock_musket", new MusketItem(new FabricItemSettings().maxDamage(500)));
